export const productsData = [
  {
    ...
    longDescription: "大黄蜂无人机考题与接单平台旨在打破传统飞手培训与实际应用的壁垒。通过构建标准化的技能评估体系，结合智能匹配算法，让每一个通过认证的飞手都能快速获得商业派单。不仅降低了企业用人成本，更为广大无人机爱好者提供了稳定可靠的变现渠道。平台引入了基于区块链的『飞历』（飞行履历）系统，确保所有飞行时长、任务评价真实不可篡改。",
    features: [
  ...
  },
  {
    ...
    longDescription: "颠覆传统地面物流的时空限制，大黄蜂无人机同城配送平台致力于打造半小时生活圈的『空中高速公路』。系统内置强大的多机型混编调度算法，支持冷链、医药、生鲜等不同载重及温控需求。通过与自动取餐柜及社区智能停机坪的无缝对接，实现『机-柜-人』的无接触高效协同闭环。目前已在多个核心城市进行规模化试运营，履约准准率达到99.9%。",
    features: [
