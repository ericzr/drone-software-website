...
export function Roadmap() {
  const phases = [
    ...
    },
    {
      ...
      description: "正式发布「大航蜂 Drone OS」企业版。将平台沉淀的庞大飞手资源转化为 B 端企业的生产力，为林业、电力、测绘等行业提供「设备+人员+任务」的一站式全流程数字化管理 SaaS。实现从「人力外包」向「标准服务输出」的盈利模式跃升。",
      status: "upcoming"
    },
    {
      year: "2027 H1",
      title: "G端监管赋能与城市空域入网",
      description: "重磅推出「一网统飞管理系统」，进军智慧城市基础设施建设。在核心试点城市配合政府与空管委，打通动态空域申请、防碰撞预警与实时航迹追踪。从「企业工具」升级为「城市低空大脑」，彻底确立行业不可替代的生态占位。",
      status: "upcoming"
    },
    {
      year: "2027 H2",
